...
const Footer = () => {
  ...
  <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-6">
    ...
    <nav className="flex space-x-6 mt-3 md:mt-0">
      <Link href="https://discord.com/users/sanjay03963" target="_blank" rel="noopener noreferrer">
        <svg
          role="img"
          viewBox="0 0 24 24"
      ...
      <Link href="https://www.linkedin.com/in/sanjay-gehlot-62b7a0301/" target="_blank" rel="noopener noreferrer">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 50 50"
          width="24"
